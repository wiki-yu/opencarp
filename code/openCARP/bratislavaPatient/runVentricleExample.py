...
EXAMPLE_DESCRIPTIVE_NAME = 'Simple Ventricle Simulation Example'
...
def run(args, job):
    ...
    meshDir = '/DockerBridge/SignalAlgos_data/openCarp/bratislavaPatient/meshes/'
    meshname = meshDir+'ventricles'
    ...
    cmd = tools.carp_cmd(tools.simfile_path(os.path.join(SCRIPT_DIR, 'ventricleExample.par')))
